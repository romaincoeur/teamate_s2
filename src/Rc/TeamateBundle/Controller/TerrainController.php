...
use Rc\TeamateBundle\Entity\Terrain;
use Rc\TeamateBundle\Form\TerrainType;
...
class TerrainController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RcTeamateBundle:Terrain')->findAll();

        return $this->render('RcTeamateBundle:Terrain:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('RcTeamateBundle:Terrain:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RcTeamateBundle:Terrain')->find($id);
        ...
        return $this->render('RcTeamateBundle:Terrain:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RcTeamateBundle:Terrain:edit.html.twig', array(
            'entity'      => $entity,
