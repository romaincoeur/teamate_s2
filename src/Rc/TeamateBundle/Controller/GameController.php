...
use Rc\TeamateBundle\Form\GameType;
...
class GameController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RcTeamateBundle:Game')->findAll();

        return $this->render('RcTeamateBundle:Game:index.html.twig', array(
            'entities' => $entities,
        ));
    }

    /**
     * Lists latest Game entities.
     *
     */
    public function latestAction()
    {
        ...
        return $this->render('RcTeamateBundle:Game:list.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('RcTeamateBundle:Game:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    /**
     * Displays a form to set parameters to new Game entity.
     *
     */
    public function parametreAction($id)
    {

        return $this->render('RcTeamateBundle:Game:parametre.html.twig');
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RcTeamateBundle:Game')->find($id);
        ...
        return $this->render('RcTeamateBundle:Game:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RcTeamateBundle:Game:edit.html.twig', array(
            'entity'      => $entity,
